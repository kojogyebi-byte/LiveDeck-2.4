...
public enum DictionaryKind: String, Codable, Sendable, CaseIterable, Identifiable {
    ...
    public var detail: String {
        switch self {
        case .offline: return "Works without internet — 147,000 English words and phrases with meanings, examples, synonyms, antonyms and pronunciation (WordNet)."
    ...
    public var needsInternet: Bool { self != .macOS && self != .custom && self != .offline }
}
...
public enum WordLookup {
    ...
    public static func url(_ kind: DictionaryKind, word: String, language: String = "en") -> URL? {
        ...
        case .macOS, .custom, .offline: return nil
        }
    }
