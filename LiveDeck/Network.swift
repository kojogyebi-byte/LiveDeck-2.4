...
/// Network (LiveDeck Link) as its own scrolling panel.
struct NetworkPanel: View {
    var body: some View { CPInspector { NetworkSections() } }
}

/// Network cards — shown at the bottom of the control panel's Input tab.
struct NetworkSections: View {
